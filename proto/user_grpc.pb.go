...
type UserServiceClient interface {
	...
	GetUsersByIds(ctx context.Context, in *UsersIdsRequest, opts ...grpc.CallOption) (UserService_GetUsersByIdsClient, error)
...
func (c *userServiceClient) GetUsersByIds(ctx context.Context, in *UsersIdsRequest, opts ...grpc.CallOption) (UserService_GetUsersByIdsClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[0], "/user_service.UserService/GetUsersByIds", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *userServiceClient) SearchUsers(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (UserService_SearchUsersClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[1], "/user_service.UserService/SearchUsers", opts...)
	if err != nil {
		return nil, err
	}
...
type UserServiceServer interface {
	...
	GetUsersByIds(*UsersIdsRequest, UserService_GetUsersByIdsServer) error
...
func (UnimplementedUserServiceServer) GetUsersByIds(*UsersIdsRequest, UserService_GetUsersByIdsServer) error {
